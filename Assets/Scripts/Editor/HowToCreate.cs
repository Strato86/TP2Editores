...
public class HowToCreate : EditorWindow
{
    ...
    void Layers()
    {
        ...
        GUILayout.Label(" In order to add Obstacles, Enemies and Event Triggers make sure to select your active layer through the dropdown menu. \n " +
                        " Once selected these ", _textStyle);
    }
    ...
    void Eventos()
    {
        ...
        GUILayout.Label(" Selecting the Event Manager option in the starting menu, you will create an Event Manager Object on the Scene. This object \n" +
                        " will allow you to create new named events and assign scripts to them in order to the untilize them in an event trigger. ", _textStyle);
    }
    ...
    void Website()
    {
        ...
        GUILayout.Label(" For additional information visit the official website at www..com ", _textStyle);
    }
}
